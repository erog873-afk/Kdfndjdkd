...
>
  ...
  <!-- Жёлоб, из которого выпадает шарик -->
  <div
    aria-hidden="true"
    class="absolute top-0 left-1/2 z-10 h-[10%] w-[11%] -translate-x-1/2 rounded-b-xl bg-gradient-to-r from-[#55565a] via-[#a0a1a5] to-[#55565a]"
  ></div>
</div>
